...
public class SDTPanel extends JPanel implements ActionListener, KeyListener, MouseListener
{
	...
	public SDTPanel()
	{
		setBackground(ColorPallette.DarkBlue);
		setForeground(ColorPallette.White);
		setBorder(BorderFactory.createLineBorder(ColorPallette.White));
		setLayout(null);
	}
